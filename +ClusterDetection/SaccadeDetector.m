classdef SaccadeDetector < handle
    ...
    methods (Static = true)
        ...
        function sacc_props_enum = GetEnum()
            ...
            enum.horizontalAmplitude = 42;
            enum.leftHorizontalAmplitude = 43;
            enum.rightHorizontalAmplitude = 44;
            
            enum.verticalAmplitude = 45;
            enum.leftVerticalAmplitude = 46;
            enum.rightVerticalAmplitude = 47;
            
            enum.horizontalDisplacement = 48;
            enum.leftHorizontalDisplacement = 49;
            enum.rightHorizontalDisplacement = 50;
            
            enum.verticalDisplacement = 51;
            enum.leftVerticalDisplacement = 52;
            enum.rightVerticalDisplacement = 53;
        ...
        function sacc_props = GetSaccadeProps( eyeRecording, sac  )
            ...
            sacc_props(:,enum.leftHorizontalAmplitude) = SaccadeDetector.GetAmplitude( pos(:,[eyeRecording.LH eyeRecording.LH]), sac );
            sacc_props(:,enum.rightHorizontalAmplitude) = SaccadeDetector.GetAmplitude( pos(:,[eyeRecording.RH eyeRecording.RH]), sac );
            sacc_props(:,enum.horizontalAmplitude) = SaccadeDetector.GetAmplitude( posAvg(:,[1 1]), sac );
            
            sacc_props(:,enum.leftVerticalAmplitude) = SaccadeDetector.GetAmplitude( pos(:,[eyeRecording.LV eyeRecording.LV]), sac );
            sacc_props(:,enum.rightVerticalAmplitude) = SaccadeDetector.GetAmplitude( pos(:,[eyeRecording.RV eyeRecording.RV]), sac );
            sacc_props(:,enum.verticalAmplitude) = SaccadeDetector.GetAmplitude( posAvg(:,[2 2]), sac );
            ...
            sacc_props(:,enum.leftHorizontalDisplacement) = pos(sac(:,2),eyeRecording.LH) - pos(sac(:,1),eyeRecording.LH);
            sacc_props(:,enum.rightHorizontalDisplacement) = pos(sac(:,2),eyeRecording.RH) - pos(sac(:,1),eyeRecording.RH);
            sacc_props(:,enum.horizontalDisplacement) = posAvg(sac(:,2),1) - posAvg(sac(:,1),1);
            
            sacc_props(:,enum.leftVerticalDisplacement) = pos(sac(:,2),eyeRecording.LV) - pos(sac(:,1),eyeRecording.LV);
            sacc_props(:,enum.rightVerticalDisplacement) = pos(sac(:,2),eyeRecording.RV) - pos(sac(:,1),eyeRecording.RV);
            sacc_props(:,enum.verticalDisplacement) = posAvg(sac(:,2),2) - posAvg(sac(:,1),2);
            ...
            [swj1 swj2] = SWJDetection.swjs(  sacc_props(:,enum.startIndex),  sacc_props(:,enum.endIndex), sacc_props(:,enum.amplitude), sacc_props(:,enum.direction), ~eyeRecording.valid, eyeRecording.samplerate )
            
            
            sacc_props(swj1,enum.SWJ)= 1:length(swj1);
            sacc_props(swj2,enum.SWJ)= 1:length(swj2);
