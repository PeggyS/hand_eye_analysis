function varargout = vergence_head_opal_cal_gui(varargin)
% VERGENCE_HEAD_OPAL_CAL_GUI MATLAB code for vergence_head_opal_cal_gui.fig
%      VERGENCE_HEAD_OPAL_CAL_GUI, by itself, creates a new VERGENCE_HEAD_OPAL_CAL_GUI or raises the existing
%      singleton*.
%
%      H = VERGENCE_HEAD_OPAL_CAL_GUI returns the handle to a new VERGENCE_HEAD_OPAL_CAL_GUI or the handle to
%      the existing singleton*.
%
%      VERGENCE_HEAD_OPAL_CAL_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VERGENCE_HEAD_OPAL_CAL_GUI.M with the given input arguments.
%
%      VERGENCE_HEAD_OPAL_CAL_GUI('Property','Value',...) creates a new VERGENCE_HEAD_OPAL_CAL_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vergence_head_opal_cal_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vergence_head_opal_cal_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vergence_head_opal_cal_gui

% Last Modified by GUIDE v2.5 24-Oct-2020 16:53:55

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
   'gui_Singleton',  gui_Singleton, ...
   'gui_OpeningFcn', @vergence_head_opal_cal_gui_OpeningFcn, ...
   'gui_OutputFcn',  @vergence_head_opal_cal_gui_OutputFcn, ...
   'gui_LayoutFcn',  [] , ...
   'gui_Callback',   []);
...
% --- Executes just before vergence_head_opal_cal_gui is made visible.
function vergence_head_opal_cal_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vergence_head_opal_cal_gui (see VARARGIN)

% Choose default command line output for vergence_head_opal_cal_gui
...
function varargout = vergence_head_opal_cal_gui_OutputFcn(hObject, eventdata, handles)
